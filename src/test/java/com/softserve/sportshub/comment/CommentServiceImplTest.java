...
class CommentServiceImplTest {
    ...
    public void shouldReturnAllComments() {
        ...
        assertThat(commentsFound.get(1).getContent()).isEqualTo(commentsExpected.get(1).getContent());
    ...
    public void givenCorrectId_whenDeleteIsCalled_shouldDeleteTheComment() {
        ...
        assertThat(commentService.findById(2L).getContent()).isEqualTo("Second test comment");
    }
    ...
    public void givenOtherUser_whenAddLikeIsCalled_shouldAddLike() {
        ...
        // then
        assertThat(commentService.findById(1L).getListOfUserLikes()).isEqualTo(Set.of(user2));
    }
    ...
    public void givenTheSameUser_whenAddLikeIsCalled_shouldNotAddLike() {
        ...
        // then
        assertThat(commentService.findById(1L).getListOfUserLikes()).isEqualTo(Set.of());
    }
